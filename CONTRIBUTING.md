# Contributing to gregor_linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
gregor_linkml. These guidelines are not strict rules.
...
The gregor_linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the gregor_linkml technical leads
...
[issues]: https://github.com/madanucd/gregor_linkml/issues/
[pulls]: https://github.com/madanucd/gregor_linkml/pulls/
